...
function contextMenu(x,y) {
  ...
  function menu() {
      ...
      d3.select('svg')
          ...
          .on('mouseover', function() {d3.select(this).select('rect').style(styles.rect.mouseover)})
          .on('mouseout', function(){d3.select(this).select('rect').style(styles.rect.mouseout) });
...
var cxtmenu = contextMenu().items('first item', 'second option', 'whatever, man');
